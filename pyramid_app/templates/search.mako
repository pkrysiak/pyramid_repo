...
<%block name = "content">
    <div class="main_box_left">
        <div class="name_product">
            ...
            <p style = "margin-top:15px"><a href = "${allegro_link}"> ${allegro_link} </a></p>
            <p style = "margin-top:15px"><a href = "${nokaut_link}"> ${nokaut_link} </a></p>
        </div>
        <div class="box_photo">
    ...
    <div class="main_box_right">
        <div class="compare_box">
            ...
            <div class="${allegro_price_mode}">${allegro_price}</div>
        </div>
        <div class="compare_box">
            <img src="${request.static_url('pyramid_app:static/img/logo_nokaut.png')}" alt="logo_nokaut"/>
            <div class="${nokaut_price_mode}">${nokaut_price}</div>
        </div>
    </div>
</%block>